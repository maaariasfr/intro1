...
public class Intro1 extends javax.swing.JFrame {
    ...
    Main juego= new Main();//juego, asi se llamara al main principal
    public Intro1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 660, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/video/gif1.gif"))); // NOI18N
